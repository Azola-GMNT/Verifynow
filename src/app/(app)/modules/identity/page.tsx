...
const identityChecks = [
  {
    id: "id-number",
    title: "ID Number",
    description: "Verify identity number and identity status.",
  },
  {
    id: "passport",
    title: "Passport",
  ...
  },
  {
    id: "biometric",
    title: "Biometric",
    description: "Verify biometric identity information.",
  },
  {
    id: "face-match",
    title: "Face Match",
    description: "Compare facial identity information.",
  },
  {
    id: "citizenship",
    title: "Citizenship",
    description: "Verify citizenship information.",
  },
  {
    id: "dha-status",
    title: "DHA Status",
    description: "Check government identity status.",
  },
  {
    id: "deceased-register",
    title: "Deceased Register",
    description: "Check deceased-person records.",
  },
  {
    id: "watchlist",
    title: "Watchlist",
    description: "Screen against relevant watchlists.",
  },
];
...
export default function IdentityModulePage() {
  ...
  function selectAll() {
    setSelectedChecks(identityChecks.map((check) => check.id));
  }
...
function startVerification() {
  ...
  window.location.href = `/verifications/new?${params.toString()}`;
}
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-500">
            Select the identity checks you want to perform.
          </p>
        </div>
        ...
        <div className="flex flex-col justify-between gap-3 rounded-xl border border-slate-200 bg-white p-4 sm:flex-row sm:items-center">
          <div>
            <p className="text-sm font-medium text-slate-900">
              {selectedChecks.length} of {identityChecks.length} checks selected
            </p>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                {selectedChecks.length === 0
                  ...
                  : `${selectedChecks.length} identity ${
