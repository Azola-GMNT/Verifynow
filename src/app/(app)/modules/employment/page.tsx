...
const employmentChecks = [
  {
    ...
    description: "Verify previous employment and employment history.",
  },
  {
    id: "employment-dates",
    title: "Employment Dates",
    description: "Verify employment start and end dates.",
  },
  {
    id: "job-title",
    title: "Job Title Verification",
    description: "Verify positions held with previous employers.",
  },
  {
    id: "reference-check",
    title: "Reference Check",
    description: "Verify professional references provided by the individual.",
  },
];
...
export default function EmploymentModulePage() {
  ...
  function selectAll() {
    setSelectedChecks(employmentChecks.map((check) => check.id));
  }
      ...
      <div className="mx-auto max-w-7xl">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-500">
            Select the employment checks you want to perform.
          </p>
        </div>
        ...
        <div className="mt-6 flex flex-col justify-between gap-3 rounded-xl border border-slate-200 bg-white p-4 sm:flex-row sm:items-center">
          <div>
            <p className="text-sm font-medium text-slate-900">
              {selectedChecks.length} of {employmentChecks.length} checks selected
            </p>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                {selectedChecks.length === 0
                  ...
                  : `${selectedChecks.length} employment ${
