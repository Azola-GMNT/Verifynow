...
const miningChecks = [
  {
    ...
    description: "Verify mining licence details and validity.",
  },
  {
    id: "mineral-rights",
    title: "Mineral Rights",
    description: "Verify mineral rights associated with the operation.",
  },
  {
    id: "export-permit",
    title: "Export Permit",
    description: "Verify applicable mineral export permits.",
  },
  {
    id: "company-status",
    title: "Mining Company Status",
    description: "Verify the legal status of the mining company.",
  },
  {
    id: "beneficial-owners",
    title: "Beneficial Ownership",
    description: "Verify beneficial ownership of the mining entity.",
  },
  {
    id: "compliance",
    title: "Mining Compliance",
    description: "Review applicable mining regulatory compliance.",
  },
];

export default function MiningModulePage() {
  ...
  function selectAll() {
    setSelectedChecks(miningChecks.map((check) => check.id));
  }
      ...
      <div className="mx-auto max-w-7xl">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-500">
            Select the mining, licence and trade checks you want to perform.
          </p>
        </div>
        ...
        <div className="mt-6 flex flex-col justify-between gap-3 rounded-xl border border-slate-200 bg-white p-4 sm:flex-row sm:items-center">
          <div>
            <p className="text-sm font-medium text-slate-900">
              {selectedChecks.length} of {miningChecks.length} checks selected
            </p>
          ...
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
              <h2 className="font-semibold text-slate-900">
                Start Mining Verification
              </h2>

              <p className="mt-1 text-sm text-slate-600">
                {selectedChecks.length === 0
                  ? "Select at least one check to continue."
                  : `${selectedChecks.length} mining ${
