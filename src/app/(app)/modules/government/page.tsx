...
const governmentChecks = [
  {
    ...
    description: "Verify identity information against government records.",
  },
  {
    id: "citizenship",
    title: "Citizenship Verification",
    description: "Verify citizenship or residency information.",
  },
  {
    id: "government-status",
    title: "Government Status",
    description: "Check relevant government record status.",
  },
  {
    id: "document-verification",
    title: "Government Documents",
    description: "Verify government-issued documentation.",
  },
];

export default function GovernmentModulePage() {
  ...
  function selectAll() {
    setSelectedChecks(governmentChecks.map((check) => check.id));
  }
      ...
      <div className="mx-auto max-w-7xl">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-500">
            Select the government record checks you want to perform.
          </p>
        </div>
        ...
        <div className="mt-6 flex flex-col justify-between gap-3 rounded-xl border border-slate-200 bg-white p-4 sm:flex-row sm:items-center">
          <div>
            <p className="text-sm font-medium text-slate-900">
              {selectedChecks.length} of {governmentChecks.length} checks selected
            </p>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                {selectedChecks.length === 0
                  ...
                  : `${selectedChecks.length} government ${
