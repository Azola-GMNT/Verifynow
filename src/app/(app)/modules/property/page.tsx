...
const propertyChecks = [
  {
    ...
    description: "Verify registered property ownership.",
  },
  {
    id: "property-registration",
    title: "Property Registration",
    description: "Verify property registration details.",
  },
  {
    id: "property-address",
    title: "Property Address",
    description: "Verify the registered property address.",
  },
  {
    id: "property-encumbrance",
    title: "Encumbrances",
    description: "Check available property restrictions and encumbrances.",
  },
  {
    id: "property-transfer",
    title: "Transfer Information",
    description: "Review available property transfer information.",
  },
];

export default function PropertyModulePage() {
  ...
  function selectAll() {
    setSelectedChecks(propertyChecks.map((check) => check.id));
  }
      ...
      <div className="mx-auto max-w-7xl">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-500">
            Select the property checks you want to perform.
          </p>
        </div>
        ...
        <div className="mt-6 flex flex-col justify-between gap-3 rounded-xl border border-slate-200 bg-white p-4 sm:flex-row sm:items-center">
          <div>
            <p className="text-sm font-medium text-slate-900">
              {selectedChecks.length} of {propertyChecks.length} checks selected
            </p>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                {selectedChecks.length === 0
                  ...
                  : `${selectedChecks.length} property ${
